...
function NavigationBarItem({ children, onClick }: { children: ComponentChildren; onClick?: () => void }) {
  return (
    <button className='text-white px-3 py-2 text-sm font-medium' onClick={onClick}>
      {children}
    </button>
  );
}
